...
class COOPAnalyzer:
    ...
    VALID_POLICIES = {"same-origin", "same-origin-allow-popups", "unsafe-none"}
...
class COEPAnalyzer:
    ...
    VALID_POLICIES = {"require-corp", "credentialless", "unsafe-none"}
...
class CORPAnalyzer:
    ...
    VALID_POLICIES = {"same-origin", "same-site", "cross-origin"}
