...
from sentinel.models import HeaderQuality, SecurityReport, Severity
...
class TestSeverityCalculation:
    ...
    def test_good_high_reduces_to_low(self):
        ...
        effective = analyzer._calculate_effective_severity(Severity.HIGH, HeaderQuality.GOOD, set())
    ...
    def test_weak_high_reduces_to_medium(self):
        ...
        effective = analyzer._calculate_effective_severity(Severity.HIGH, HeaderQuality.WEAK, set())
        assert effective == Severity.MEDIUM
...
class TestSimpleHeaderValidation:
    ...
    def test_x_frame_options_invalid(self):
        ...
        quality, issues, _, types = analyzer._simple_validate("x-frame-options", "INVALID")
        assert quality == HeaderQuality.WEAK
    ...
    def test_x_content_type_options_valid(self):
        ...
        quality, issues, _, _ = analyzer._simple_validate("x-content-type-options", "nosniff")
        assert quality == HeaderQuality.EXCELLENT
        assert len(issues) == 0
    ...
    def test_x_content_type_options_invalid(self):
        ...
        quality, issues, _, types = analyzer._simple_validate("x-content-type-options", "invalid")
        assert quality == HeaderQuality.WEAK
...
class TestRedirectChainAnalysis:
    ...
    def test_no_redirects(self):
        ...
        chain = [RedirectHop("https://example.com", 200, None, "https")]
...
class TestAnalyzerIntegration:
    ...
    async def test_analyze_information_disclosure(self):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            disclosure_headers = [
                a for a in report.analyses if a.quality == HeaderQuality.DANGEROUS
            ]
...
class TestHeaderConfigurations:
    ...
    def test_high_severity_headers(self):
        ...
        high_severity = [
            name
            for name, config in analyzer.HEADER_CONFIGS.items()
