...
class TestCOOPAnalyzer:
    ...
    def test_unsafe_none_weak(self):
        ...
        assert any("no isolation" in issue.lower() or "unsafe" in issue.lower() 
                   for issue in issues)
...
class TestCOEPAnalyzer:
    ...
    def test_unsafe_none_weak(self):
        ...
        assert quality == HeaderQuality.WEAK
        assert any("no protection" in issue.lower() or "unsafe" in issue.lower() 
                   for issue in issues)
...
class TestCORPAnalyzer:
    ...
    def test_same_site_good(self):
        ...
        assert quality == HeaderQuality.GOOD
        assert any("same-site" in issue.lower() or "cross-origin" in issue.lower() 
                   for issue in issues)
    ...
    def test_cross_origin_weak(self):
        ...
        assert quality == HeaderQuality.WEAK
        assert any("unrestricted" in issue.lower() or "cross-origin" in issue.lower() 
                   for issue in issues)
